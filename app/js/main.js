$(function () {
  ...
  $(".tracks__slider").slick({
    ...
    speed: 500,
    prevArrow:
      '<button class="slick-prev slick-arrow" aria-label="Next" type="button"><svg width="71" height="16" viewBox="0 0 71 16" xmlns="http://www.w3.org/2000/svg"><path d="M0.292892 7.29289C-0.0976334 7.68342 -0.0976334 8.31658 0.292892 8.70711L6.65685 15.0711C7.04738 15.4616 7.68054 15.4616 8.07107 15.0711C8.46159 14.6805 8.46159 14.0474 8.07107 13.6569L2.41422 8L8.07107 2.34315C8.46159 1.95262 8.46159 1.31946 8.07107 0.928932C7.68054 0.538408 7.04738 0.538408 6.65685 0.928932L0.292892 7.29289ZM71 7L1 7V9L71 9V7Z" fill="url(#paint0_linear_98:28)"/><defs><linearGradient id="paint0_linear_98:28" x1="36" y1="8" x2="1" y2="8"gradientUnits="userSpaceOnUse"><stop stop-color="#518EAA"/><stop offset="1" stop-color="#5DDDC1"/></linearGradient></defs></svg></button>',
    nextArrow:
